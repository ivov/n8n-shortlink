...
COMPOSE_PROJECT_NAME=n8n_shortlink docker compose --file deploy/docker-compose.monitoring.yml pull
COMPOSE_PROJECT_NAME=n8n_shortlink docker compose --file deploy/docker-compose.yml pull
